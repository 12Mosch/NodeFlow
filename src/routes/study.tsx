...
export const Route = createFileRoute('/study')({
  ...
  loader: async ({ context }) => {
    // Load all potential data - React Query will cache it
    // This way we don't need to conditionally load based on search params
    await Promise.all([
...
type StudyState = 'overview' | 'selecting' | 'studying'
...
// Spaced Repetition Mode Component
...
function RandomMode({ studyState, setStudyState, onGoHome }: RandomModeProps) {
