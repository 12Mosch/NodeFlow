...
export const listByDatabase = query({
  ...
  handler: async (ctx, args) => {
    return await Sentry.startSpan(
      { name: 'databaseRows.listByDatabase', op: 'convex.query' },
      async () => {
...
export const create = mutation({
  ...
  handler: async (ctx, args) => {
    return await Sentry.startSpan(
      { name: 'databaseRows.create', op: 'convex.mutation' },
      async () => {
        // Check document access
...
export const updateCell = mutation({
  ...
  handler: async (ctx, args) => {
    return await Sentry.startSpan(
      { name: 'databaseRows.updateCell', op: 'convex.mutation' },
      async () => {
...
export const updateCells = mutation({
  ...
  handler: async (ctx, args) => {
    return await Sentry.startSpan(
      { name: 'databaseRows.updateCells', op: 'convex.mutation' },
      async () => {
        const row = await ctx.db.get(args.rowId)
        if (!row) {
          throw new Error('Row not found')
...
export const delete_ = mutation({
  ...
  handler: async (ctx, args) => {
    return await Sentry.startSpan(
      { name: 'databaseRows.delete', op: 'convex.mutation' },
      async () => {
        const row = await ctx.db.get(args.rowId)
        if (!row) {
          throw new Error('Row not found')
...
export const reorder = mutation({
  ...
  handler: async (ctx, args) => {
    return await Sentry.startSpan(
      { name: 'databaseRows.reorder', op: 'convex.mutation' },
      async () => {
        // Check document access
