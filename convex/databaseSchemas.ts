...
export const getByBlockId = query({
  ...
  handler: async (ctx, args) => {
    return await Sentry.startSpan(
      { name: 'databaseSchemas.getByBlockId', op: 'convex.query' },
      async () => {
...
export const create = mutation({
  ...
  handler: async (ctx, args) => {
    return await Sentry.startSpan(
      { name: 'databaseSchemas.create', op: 'convex.mutation' },
      async () => {
        // Check document access
...
export const update = mutation({
  ...
  handler: async (ctx, args) => {
    return await Sentry.startSpan(
      { name: 'databaseSchemas.update', op: 'convex.mutation' },
      async () => {
...
export const addColumn = mutation({
  ...
  handler: async (ctx, args) => {
    return await Sentry.startSpan(
      { name: 'databaseSchemas.addColumn', op: 'convex.mutation' },
      async () => {
        const schema = await ctx.db.get(args.schemaId)
        if (!schema) {
          throw new Error('Schema not found')
...
export const deleteColumn = mutation({
  ...
  handler: async (ctx, args) => {
    return await Sentry.startSpan(
      { name: 'databaseSchemas.deleteColumn', op: 'convex.mutation' },
      async () => {
        const schema = await ctx.db.get(args.schemaId)
        if (!schema) {
          throw new Error('Schema not found')
...
export const updateColumn = mutation({
  ...
  handler: async (ctx, args) => {
    return await Sentry.startSpan(
      { name: 'databaseSchemas.updateColumn', op: 'convex.mutation' },
      async () => {
        const schema = await ctx.db.get(args.schemaId)
        if (!schema) {
          throw new Error('Schema not found')
